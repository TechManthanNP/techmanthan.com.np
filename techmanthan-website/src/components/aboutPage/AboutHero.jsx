...
//           <h1><span>Founded</span> in 2025</h1>
//           <p>We set out with a mission to redefine how enterprises leverage artificial intelligence, not with buzzwords, but with real, measurable value.</p>
//           <p>We build intelligent software designed to address the practical challenges modern organizations. From automating workflows to delivering predictive insights, our solutions are built with scalability, security, and impact at the core. face.</p>
//           <p>As a startup, we're agile, curious, and deeply committed to creating technology that adapts, evolves, and delivers for the businesses of today and the needs of tomorrow.</p>
//         </div>
//       </div>
...
const AboutHero = () => {
  ...
  useEffect(() => {
    if (isInView) {
      // Animate text from bottom to final position
      controls.start({
        y: ["100%", "0%"],
        transition: { duration: 5, ease: "easeOut" },
      });
    } else {
      // Reset text to start when leaving view
      controls.set({ y: "100%" });
    }
  }, [isInView, controls]);
  ...
  return (
    <section className="about-hero">
      ...
      <div className="content">
        <motion.div className="scroll-text" ref={scrollRef} animate={controls}>
          <h1>
